...
//const inputName = document.querySelector('.js_name'); (Variable declarada en el archivo de arrows)
//const jobPreview = document.querySelector('.js_preview_job');
//const inputJob = document.querySelector('.js_job_position'); (Variable declarada en el archivo de arrows)
